...
:local_node_handler("~"),global_node_handler()
{
	...
	// Register callbacks
	ch1.transmit_cb = new CallbackHandler<sdc2130>(this,&sdc2130::transmit);
	ch2.transmit_cb = new CallbackHandler<sdc2130>(this,&sdc2130::transmit);
	ch1.init_cb = new CallbackHandler<sdc2130>(this,&sdc2130::initController);
	ch2.init_cb = new CallbackHandler<sdc2130>(this,&sdc2130::initController);
...
void sdc2130::onStatusTimer(const ros::TimerEvent& event)
{
...
void sdc2130::updateStatus(void)
{
...
void sdc2130::initController(std::string config)
{
	/*
